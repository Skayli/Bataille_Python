...
liste_cartes_jouees = ["as_coeur.png", "as_pique.png", "as_trefle.png", "as_carreau.png"]
...
for image in liste_cartes_jouees:
    ...
    photo = ImageTk.PhotoImage(file= "D:\Atom_workspace\Python\Puissance_4\images\{}".format(image))
